...
# A sample database of Fintech Finder candidates including their name, digital address, rating and hourly cost per Ether.
candidate_database = {
...
# Create the input field to record the number of hours the candidate worked
...
# Create the "Send Transaction" button
if st.sidebar.button("Send Transaction"):

    #call the send_transaction function and return the transaction_hash.
...
# This function writes FinTech Finder candidates to the Streamlit page
get_people(w3)